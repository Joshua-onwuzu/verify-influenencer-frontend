    ...
    <div className="w-full flex flex-col gap-8">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-2 mb-2">
            {details?.categories.map((data, key) => (
              <div key={key} className="px-2 py-1 rounded-lg text-[#9da0a6] text-sm bg-[#17212f]">
                {data}
              </div>
            ))}
          </div>
          <p className="text-[#9da0a6] max-w-[700px]">
      ...
      <div className="grid grid-cols-3 gap-8">
        <div className="grid-cols-1 border-[#252f3f] border items-center rounded-md p-8 bg-[#17212f]">
          <p className="text-white text-sm font-semibold mb-2">Average Trust Score</p>
          <div>
            <p className="font-bold text-4xl mb-2 text-[#0eba80]">
              {details?.average_trust_score}%
            </p>
            <p className=" text-xs text-[#9da0a6]">Average trust score for this influencer</p>
          </div>
        </div>
        <div className="grid-cols-1 border-[#252f3f] border items-center rounded-md p-8 bg-[#17212f]">
          <p className="text-white text-sm font-semibold mb-2">Total Claims</p>
          <div>
        ...
        <div className="grid-cols-1 border-[#252f3f] border items-center rounded-md p-8 bg-[#17212f]">
          <p className="text-white text-sm font-semibold mb-2">Verified Claims</p>
          <div>
      ...
      <div>
        <div className="flex">
          ...
          <div className="  p-4 text-[#9da0a6] cursor-not-allowed">
        ...
        <div>
          {details?.detail.claim.map((data, key) => (
            <div
              key={key}
              className="p-4 border-b border-[#252f3f] flex items-center justify-between"
            >
              <div>
              ...
              <div>
                <p
                  className={`text-2xl text-end font-semibold mb-2 ${data.trust_score >= 75 ? 'text-[#0eba80]' : data.trust_score >= 60 ? 'text-[#efc416]' : data.trust_score >= 30 ? 'text-orange-400' : 'text-red-500'}`}
                >
                  {data.trust_score}%
                </p>
