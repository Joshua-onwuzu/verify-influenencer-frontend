...
const LeaderboardPage = () => {
  const {averageTrustScore, totalClaims, verifiedClaims, categories, categoryQuery, setQueryByCategory, claims} = useLeaderBoard()
  return (
  ...
  <button        onClick={() => setQueryByCategory('All')} className={`p-2 px-4 text-white w-auto text-sm flex justify-center items-center rounded-3xl ${categoryQuery === 'All' && 'bg-[#0eba80]'}  `}>
    All
  </button>
